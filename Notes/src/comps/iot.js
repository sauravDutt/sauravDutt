...
const Internet = () => {
    ...
    const showReadMore = () => {
        document.getElementById('read-more-iot').style.display='block';
        document.getElementById('readMoreBtnIot').style.display = 'none';
        document.getElementById('readLessBtnIot').style.display = 'block';
    }

    const showReadLess = () => {
        document.getElementById('read-more-iot').style.display='none';
        document.getElementById('readMoreBtnIot').style.display = 'block';
        document.getElementById('readLessBtnIot').style.display = 'none';
    }

    return (
        <div className="post-blog">
            <div className='post-info'>
                <h3 className='post-title'>Internet Of Things</h3>
                <p>
                ...
                <p id='read-more-iot'>
                    ...
                    <br />
                    <span><button onClick={showReadMore} className="homeBtn" id='readMoreBtnIot'>Read More</button><button onClick={showReadLess} className="homeBtn" id='readLessBtnIot'>Read Less</button></span>
                    <br />
            </div>
            <br />
        </div>
