...
const JavaScript = () => {
    ...
    const showReadMore = () => {
        document.getElementById('read-more-js').style.display='block';
        document.getElementById('readMoreBtn').style.display = 'none';
        document.getElementById('readLessBtn').style.display = 'block';
    }

    const showReadLess = () => {
        document.getElementById('read-more-js').style.display='none';
    ...
    return (
        <div className="post-blog">
            <div className='post-info'>
                <h3 className='post-title'>JavaScript</h3>
                <p>
                ...
                <p id='read-more-js'>
                    ...
                    <br />
                    <span><button onClick={showReadMore} className="homeBtn" id='readMoreBtn'>Read More</button><button onClick={showReadLess} className="homeBtn" id='readLessBtn'>Read Less</button></span>
                    <br />
            </div>
            <br />
        </div>
